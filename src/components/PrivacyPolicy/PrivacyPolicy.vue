<template>
    ...
    <div class="infoLanding">
            ...
            <p>
                Los derechos que asisten al USUARIO son: Derecho a retirar el consentimiento en cualquier momento. Derecho de acceso, rectificación, portabilidad y supresión de sus datos, y de limitación u oposición a su tratamiento. Derecho a presentar una reclamación ante la autoridad de control (www.aepd.es) si considera que el tratamiento no se ajusta a la normativa vigente. Datos de contacto para ejercer sus derechos: Santiago Alonso Estrada Regueiro. Avda. de los Derechos Humanos, nº 2, Local 12 - 28924 Alcorcón (Madrid). E-mail: santiagoestradar@gmail.com 
            </p>
            <br>
            <p class="titleCenter">2. CARÁCTER OBLIGATORIO O FACULTATIVO DE LA INFORMACIÓN FACILITADA POR EL USUARIO </p>
            ...
            <p>Que de conformidad con lo dispuesto en las normativas vigentes en protección de datos personales, el RESPONSABLE está cumpliendo con todas las disposiciones de las normativas GDPR y LOPDGDD para el tratamiento de los datos personales de su responsabilidad, y manifiestamente con los principios descritos en el artículo 5 del GDPR, por los cuales son tratados de manera lícita, leal y transparente en relación con el interesado y adecuados, pertinentes y limitados a lo necesario en relación con los fines para los que son tratados. El RESPONSABLE garantiza que ha implementado políticas técnicas y organizativas apropiadas para aplicar las medidas de seguridad que establecen el GDPR y la LOPDGDD con el fin de proteger los derechos y libertades de los USUARIOS y les ha comunicado la información adecuada para que puedan ejercerlos. Para más información sobre las garantías de privacidad, puedes dirigirte al RESPONSABLE a través de Santiago Alonso Estrada Regueiro. Avda. de los Derechos Humanos, nº 2, Local 12 - 28924 Alcorcón (Madrid). E-mail: santiagoestradar@gmail.com </p>
        </div>
   <PageDivider/>
   <AppFooter/>
</template>
